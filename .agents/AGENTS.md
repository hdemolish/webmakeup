...
# Mandatory Gemini Guidelines
You MUST read and strictly adhere to the rules in [gemini.md](file:///Users/lelongphoto/webmakeup/gemini.md) for every coding task.
